...
-- after logging in for the first time (first_login 300 Miles) — enough to
-- afford the cheapest partner voucher (ai_chart_analyst_5) without needing
-- to join a competition first. Subsequent quick wins (first_join 100,
...
VALUES
  ...
  ('ai_chart_analyst_5', 'third_party_tool', 'AI Chart Analyst — 5 credits',
   ...
   250, NULL, true, '{"partner_url":"https://deriv.com"}'::jsonb, 41),
  ('ai_chart_analyst_20', 'third_party_tool', 'AI Chart Analyst — 20 credits',
   ...
   900, NULL, true, '{"partner_url":"https://deriv.com"}'::jsonb, 42),
  ('pro_trading_signals', 'third_party_tool', 'Pro Trading Signals (7 days)',
   ...
   500, NULL, true, '{"partner_url":"https://deriv.com"}'::jsonb, 43)
